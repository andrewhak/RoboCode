...
# Creates the following array initial_positions = [0, 0, 0, 0, 0, 0]
last_positions = [0] * 6
            ...
            with open(input_filename, 'r') as input_file, open(output_filename, 'w') as output_file:
                ...
                for line in input_file:
                    ...
                    if line.startswith("G90"):
                        ...
                        # Converts values to floats if they contain a . or integers if they don't
                        ...
                        if len(values) >= 7:
                            for axis_id, position in enumerate(values[1:7], start=1):
                                ...
                                # Converts hexidecimal string into a list of integers that's passed to calculate crc to build the crc
